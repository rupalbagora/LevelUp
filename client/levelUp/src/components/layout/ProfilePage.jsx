...
import { Share2, Edit3, Trophy, Target, Award, Flame, Zap, Target as TargetIcon } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="pt-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between px-5 py-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl text-sm font-bold text-slate-700 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-500/10 hover:border-blue-300 dark:hover:border-blue-500/30 hover:text-[#2563eb] dark:hover:text-cyan-400 transition-all group"
                  >
                    ...
                    <motion.span
                      ...
                      className="text-slate-400 group-hover:text-[#2563eb] dark:group-hover:text-cyan-400"
                    >
                      ▼
                    </motion.span>
                  </button>
 
                  {/* Password Fields — appear on toggle */}
                  <AnimatePresence>
                    {showPasswordFields && (
                      <motion.div
                      ...
                      >
                        <div className="mt-4 p-5 bg-blue-50/50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-500/20 rounded-2xl space-y-4">
                          
                          {/* Password Rules Info */}
                          <div className="text-[10px] text-slate-500 dark:text-slate-400 bg-white dark:bg-white/5 rounded-xl px-4 py-3 border border-gray-100 dark:border-white/5 leading-relaxed">
                            <span className="font-black text-slate-700 dark:text-slate-300 block mb-1">Password must include:</span>
                          ...
                          <div className="space-y-2">
                            ...
                            <input 
                              ...
                              className="w-full bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl px-5 py-3.5 text-slate-900 dark:text-white outline-none focus:border-[#2563eb] dark:focus:border-cyan-400 transition-all text-sm"
                            />
                            {/* Strength Bar */}
                            {passwordStrength && (
                              <div className="space-y-1.5">
                                ...
                                <p className={`text-[10px] font-bold ml-1 ${passwordStrength.textColor}`}>
                          ...
                          <div className="space-y-2">
                            ...
                            {formData.confirmPassword && (
                              <p className={`text-[10px] font-bold ml-1 ${formData.newPassword === formData.confirmPassword ? 'text-green-500' : 'text-red-500'}`}>
                          ...
                          <motion.button
                            ...
                            onClick={() => {
                              ...
                              // Mark password as confirmed — actual save happens on Save Changes
                              alert("✅ Password confirmed! Click 'Save Changes' to apply.");
                            }}
                            className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-[#2563eb] to-[#7c3aed] text-white text-sm font-bold shadow-md hover:scale-[1.01] active:scale-95 transition-all"
                          >
                            ✅ OK Confirm
                          </motion.button>
                        </div>
      ...
      <AnimatePresence>
        {passwordSuccess && (
          <motion.div
            ...
            className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[200] flex items-center gap-4 px-8 py-4 bg-white dark:bg-[#0b1120] border border-green-200 dark:border-green-500/30 rounded-2xl shadow-2xl shadow-green-500/10"
          >
            <div className="w-10 h-10 bg-green-100 dark:bg-green-500/20 rounded-xl flex items-center justify-center text-xl">
              🔐
            </div>
            <div>
              <p className="font-black text-slate-900 dark:text-white text-sm">Password Changed!</p>
              <p className="text-xs text-green-600 dark:text-green-400 font-medium">Your password has been updated successfully.</p>
            </div>
